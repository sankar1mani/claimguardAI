  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-slide-up">
      ...
      {result.fraud_detection && (
        <FraudDetectionCard fraudDetection={result.fraud_detection} />
      )}

      {/* If fraud detection recommends REJECT, hide the rest of the analysis */}
      {result.fraud_detection?.recommendation === 'REJECT' ? null : (
        <>
